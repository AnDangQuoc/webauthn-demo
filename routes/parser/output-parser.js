...
const { prettifyTransformations } = require("./transformations.js")

const cbor = require("cbor")
const log = require("loglevel")

module.exports = {
  parseAuthenticatorData: function (data) {
    const d =
  ...
  parseAttestationObject: function (data) {
    const buffer =
      data instanceof ArrayBuffer
        ? Buffer.from(data)
  ...
  parseClientDataJSON: function (data) {
  ...
  splitCredentialsByType: function (credentials) {
  ...
  orderCredentialsByType: function (credentials) {
  ...
  prettyCredentialsWithHtml: function (prettyCredentials) {
